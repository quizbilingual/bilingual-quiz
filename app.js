...
// 🗂️ Add subject & difficulty mapping here
const subjectMap = {
  "TNPSC Group 1": "tnpsc",
...
function loadQuestions() {
  fetch("data/questions.json")
    ...
    .catch(err => {
      ...
      document.getElementById("questionText").textContent = "⚠️ Failed to load questions.";
    });
}
...
function loadQuestion() {
  // 🧠 Use mapping to match dropdown labels with schema keys
  const selectedSubject = subjectMap[document.getElementById("subjectSelect").value] || "all";
  const selectedDifficulty = difficultyMap[document.getElementById("difficultySelect").value] || "all";
